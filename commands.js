...
// 1. Create a database called jaskis
    use jaskis 
    run "db" to confirm youre in jaskis database

// 2. Create a collection called bounties
     run `db.createCollection('bounties')`
...
db.bounties.find({name: {$and: "Grandhog"}})
// Update and Delete
// 1. Update the reward for Polarwind to 10000
db.bounties.updateOne({reward: 4000}, {$set: {reward: 10000}})
// 2. Remove Lokinkajou
db.bounties.deleteOne({_id:ObjectId('62fc3e62ba125dcb73593f04')})
